...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
<<<<<<< HEAD
            selector: 'page-home',template:/*ion-inline-start:"/home/caio/Dropbox/CTI/TCC/Mobile/github/houzionAppMobile/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title class="title">\n      <img class="icon" src="assets/imgs/170.png">\n    </ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content class="card-background-page">\n  <div class="ambiente_name">\n    <p class="ambiente_name">\n      <b>Casa</b>\n    </p>\n\n  </div>\n\n  <div class="monitoring"></div>\n  <div class="main_component">\n    <div class="component">\n      <img class="img_component" src="assets/imgs/light.png" />\n      <p class="name_component">Luz</p>\n      <p class="status">Ativado</p>\n      <a class="detalhes_link" href="">Mais detalhes</a>\n    </div>\n    <div class="component">\n      <img class="img_component" src="assets/imgs/light.png" />\n      <p class="name_component">Luz</p>\n      <p class="status">Ativado</p>\n      <a class="detalhes_link" href="">Mais detalhes</a>\n    </div>\n    <div class="component">\n      <img class="img_component" src="assets/imgs/light.png" />\n      <p class="name_component">Luz</p>\n      <p class="status">Ativado</p>\n      <a class="detalhes_link" href="">Mais detalhes</a>\n    </div>\n    <div class="component">\n        <img class="img_component" src="assets/imgs/light.png" />\n        <p class="name_component">Luz</p>\n        <p class="status">Ativado</p>\n        <a class="detalhes_link" href="">Mais detalhes</a>\n      </div>\n      <div class="component">\n        <img class="img_component" src="assets/imgs/light.png" />\n        <p class="name_component">Luz</p>\n        <p class="status">Ativado</p>\n        <a class="detalhes_link" href="">Mais detalhes</a>\n      </div>\n      <div class="component">\n        <img class="img_component" src="assets/imgs/light.png" />\n        <p class="name_component">Luz</p>\n        <p class="status">Ativado</p>\n        <a class="detalhes_link" href="">Mais detalhes</a>\n      </div>\n      <div class="component">\n      <img class="img_component" src="assets/imgs/light.png" />\n      <p class="name_component">Luz</p>\n      <p class="status">Ativado</p>\n      <a class="detalhes_link" href="">Mais detalhes</a>\n    </div>\n    <div class="component">\n      <img class="img_component" src="assets/imgs/light.png" />\n      <p class="name_component">Luz</p>\n      <p class="status">Ativado</p>\n      <a class="detalhes_link" href="">Mais detalhes</a>\n    </div>\n    <div class="component">\n      <img class="img_component" src="assets/imgs/light.png" />\n      <p class="name_component">Luz</p>\n      <p class="status">Ativado</p>\n      <a class="detalhes_link" href="">Mais detalhes</a>\n    </div>\n    <div class="component">\n        <img class="img_component" src="assets/imgs/light.png" />\n        <p class="name_component">Luz</p>\n        <p class="status">Ativado</p>\n        <a class="detalhes_link" href="">Mais detalhes</a>\n      </div>\n      <div class="component">\n        <img class="img_component" src="assets/imgs/light.png" />\n        <p class="name_component">Luz</p>\n        <p class="status">Ativado</p>\n        <a class="detalhes_link" href="">Mais detalhes</a>\n      </div>\n      <div class="component">\n        <img class="img_component" src="assets/imgs/light.png" />\n        <p class="name_component">Luz</p>\n        <p class="status">Ativado</p>\n        <a class="detalhes_link" href="">Mais detalhes</a>\n      </div>\n  </div>\n\n\n</ion-content>'/*ion-inline-end:"/home/caio/Dropbox/CTI/TCC/Mobile/github/houzionAppMobile/src/pages/home/home.html"*/
=======
...
>>>>>>> 0338549855be389ac4b80f878d0397262503f3b1
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
<<<<<<< HEAD
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/caio/Dropbox/CTI/TCC/Mobile/github/houzionAppMobile/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/home/caio/Dropbox/CTI/TCC/Mobile/github/houzionAppMobile/src/app/app.html"*/
=======
...
var AmbientesPage = /** @class */ (function () {
    function AmbientesPage(navCtrl, navParams) {
        ...
        this.dados_ambiente.ambiente[0].componente[0].titleCard = "Luzes";
        ...
        this.dados_ambiente.ambiente[0].componente[0].srcImg = "assets/imgs/light.png";
    ...
    AmbientesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
<<<<<<< HEAD
            selector: 'page-ambientes',template:/*ion-inline-start:"/home/caio/Dropbox/CTI/TCC/Mobile/github/houzionAppMobile/src/pages/ambientes/ambientes.html"*/'<!--\n  Generated template for the AmbientesPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n      <button ion-button menuToggle>\n          <ion-icon name="menu"></ion-icon>\n        </button>\n    <ion-title class = "title"><img class = "icon"src = {{dados_ambiente.title}} ></ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content  class="card-background-page">\n  <div class = "ambiente_name">\n    <p class = "ambiente_name"><b>{{dados_ambiente.ambiente[0].nome}}</b></p>\n    \n  </div>\n  <div class="monitoramento_rapido">\n\n  </div>\n  \n     <div class="monitoring"></div>\n     <div class= "main_component">\n       <div class = "component">\n        <img class = "img_component" src = {{dados_ambiente.ambiente[0].componentes[0].srcImg}}/> \n        <p class = "name_component">{{dados_ambiente.ambiente[0].componentes[0].titleCard}}</p>\n        <p class = "status">{{dados_ambiente.ambiente[0].componentes[0].status}}</p>\n        <a class = "detalhes_link" href = "">Mais detalhes</a>\n      </div>\n      <div class = "component">\n          <img class = "img_component" src = {{dados_ambiente.ambiente[0].componentes[0].srcImg}}/> \n          <p class = "name_component">{{dados_ambiente.ambiente[0].componentes[0].titleCard}}</p>\n          <p class = "status">{{dados_ambiente.ambiente[0].componentes[0].status}}</p>\n          <a class = "detalhes_link" href = "">Mais detalhes</a>\n        </div>\n        <div class = "component">\n            <img class = "img_component" src = {{dados_ambiente.ambiente[0].componentes[0].srcImg}}/> \n            <p class = "name_component">{{dados_ambiente.ambiente[0].componentes[0].titleCard}}</p>\n            <p class = "status">{{dados_ambiente.ambiente[0].componentes[0].status}}</p>\n            <a class = "detalhes_link" href = "">Mais detalhes</a>\n          </div>\n     </div>\n    \n  </ion-content>\n'/*ion-inline-end:"/home/caio/Dropbox/CTI/TCC/Mobile/github/houzionAppMobile/src/pages/ambientes/ambientes.html"*/,
=======
